  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <motion.div
        ...
        className="absolute top-1/4 right-[10%] h-72 w-72 rounded-full bg-amber-500/8 blur-3xl"
      />
      <motion.div
        animate={{ y: [10, -10, 10] }}
        transition={{ duration: 8, repeat: Infinity, ease: "easeInOut" }}
        className="absolute bottom-1/4 left-[5%] h-56 w-56 rounded-full bg-orange-500/8 blur-3xl"
      />
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 backdrop-blur-sm border border-white/10 text-white/80 text-sm font-medium mb-6">
            ...
            >
              India&apos;s most trusted self-drive car rental platform. Book top-rated vehicles by the hour or day — no driver, pure freedom.
            </motion.p>
            ...
            >
              <Link href="/cars">
                <Button variant="gradient" size="lg" className="gap-2 shadow-2xl shadow-amber-500/20">
          ...
          >
            <div className="relative">
              <div className="rounded-3xl overflow-hidden bg-white/5 backdrop-blur-sm border border-white/10 p-8">
                <div className="aspect-[4/3] rounded-2xl bg-gradient-to-br from-white/5 to-white/[0.02] flex items-center justify-center">
                  <div className="text-center">
                    <div className="text-8xl mb-4">🚗</div>
                    <p className="text-white/40 text-sm">Premium Self-Drive Experience</p>
                  </div>
                </div>
                <motion.div
                  animate={{ y: [-5, 5, -5] }}
