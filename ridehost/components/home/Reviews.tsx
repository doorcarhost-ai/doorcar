...
const ALL_REVIEWS = [
  ...
  { name: "Rahul Verma", rating: 5, text: "RideHost is incredible. Booked a Creta for a road trip — flawless experience from start to finish.", car: "Hyundai Creta", trips: 5 },
  ...
  { name: "Meera Pillai", rating: 5, text: "The Range Rover experience was breathtaking. RideHost is my go-to platform from now on.", car: "Range Rover", trips: 4 },
  ...
  { name: "Suresh Patel", rating: 5, text: "Clean cars, honest hosts, transparent pricing. RideHost is far ahead of any competitor.", car: "Maruti Swift", trips: 20 },
  ...
  { name: "Manish Gupta", rating: 5, text: "RideHost is the Airbnb of cars. Premium experience, trustworthy hosts, excellent value.", car: "Mahindra Thar", trips: 8 },
  { name: "Neha Chopra", rating: 5, text: "Drove the Defender through the Western Ghats — life-changing experience made possible by RideHost.", car: "Land Rover Defender", trips: 2 },
